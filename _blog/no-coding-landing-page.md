---
layout: post
title: "Tools you can use to create a website & landing page when you have limited/no coding skills"
description: "You are looking to set up your landing page or website but don't know where to start?"
...
You can also buy your theme from [themeforest.com](http://themeforest.com); that's a straightforward process. Once you buy the theme, you can directly upload the theme and follow the author documented process to create a website like the way he is showing in the picture.
...
### [Leadpages.net](http://Leadpages.net)
...
That's why I decided to tell you about some of my favourite tools for doing it! Many of us don't want to follow the conventional template because sometimes they don't look good, or sometimes their content doesn't fit in the pre-built template.
...
3.  Checkout Pages
4.  Upsells & Downsells
5.  Lead & Sales Funnels
6.  Stats & Split Testing
...
### [Elementor](https://www.elementor.com)(this is what I use personally)

If you think why I am not using the optimizepress over elementor, then here is the reason:

1.  I had never heard about optimizepress until I created my own website.
2.  Optimizepress is built especially for landing pages, not for an entire website.
