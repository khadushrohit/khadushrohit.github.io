---
layout: post
title: "How to get UI/UX job as a beginner designer in a typical Indian startup (that has <50 employees) "
description: "Have you seen the LinkedIn post where beginner designers frequently post that they are looking for a job?"
...
90% are made upon [Behance.net](http://Behance.net). There is no problem with it.
...
Startups focus on UI and the final outcome of your case study, then don't care much about the [process](/blog/design-process/).
